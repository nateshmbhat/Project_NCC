...
""))
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, -1637, 966, 2245))
...
"height:30%;"))
        ...
        self.checkBox = QtGui.QCheckBox(self.DataEntry)
...
"}"))
        ...
        self.settingsscrollAreaWidgetContents.setGeometry(QtCore.QRect(0, -946, 972, 1748))
...
"}"))
        ...
        MainWindow.setTabOrder(self.locationLineEdit, self.checkBox)
        MainWindow.setTabOrder(self.checkBox, self.startdateDateEdit)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.checkBox.setText(_translate("MainWindow", "Eligible", None))
