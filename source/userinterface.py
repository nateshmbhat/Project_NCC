...
""))
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, -480, 785, 1899))
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"height:30%;"))
        ...
        self.startdateLabel.setStyleSheet(_fromUtf8("background-color:lightblue;border-radius:10px;margin:3px;\n"
"color:gray;"))
...
"border-radius:5px;"))
        ...
        self.enddateLabel.setStyleSheet(_fromUtf8("background-color:lightblue;border-radius:10px;margin:3px;\n"
"color:gray;"))
...
"}"))
        ...
        self.settingsscrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 972, 1570))
...
"text-align:center;"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.selectpicturePushButton.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">Select Picture of the Candidate</span></p></body></html>", None))
        ...
        self.enrolmentuploaddataLineEdit.setPlaceholderText(_translate("MainWindow", "Enrolment Numbers", None))
        self.locationLineEdit.setPlaceholderText(_translate("MainWindow", "Location", None))
