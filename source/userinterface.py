...
""))
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 1068, 1899))
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"}"))
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 1081, 696))
...
"}"))
        ...
        self.settingsscrollAreaWidgetContents.setGeometry(QtCore.QRect(0, -217, 1066, 1094))
...
"color:white;"))
        ...
        self.settings_institutionListWidget.setStyleSheet(_fromUtf8("background-color:rgb(229, 229, 229);"))
...
"color:white;"))
        ...
        self.gridLayout_12.addLayout(self.horizontalLayout_16, 2, 2, 1, 1)
...
"text-align:center;"))
        ...
        self.label_4 = QtGui.QLabel(self.formsandfieldsgridwidget)
        font = QtGui.QFont()
        ...
        self.label_4.setStyleSheet(_fromUtf8("background-color:qlineargradient(spread:pad, x1:0.012, y1:0.755818, x2:0.641818, y2:0.392, stop:0 rgba(230, 255, 0, 255), stop:1 rgba(85, 104, 255, 150));"))
        ...
        self.settings_formsListWidget.setStyleSheet(_fromUtf8("background-color:rgb(229, 229, 229);"))
        ...
        font.setStyleStrategy(QtGui.QFont.PreferDefault)
        item.setFont(font)
        brush = QtGui.QBrush(QtGui.QColor(98, 255, 0))
        brush.setStyle(QtCore.Qt.Dense3Pattern)
        item.setBackground(brush)
        self.settings_formsListWidget.addItem(item)
        item = QtGui.QListWidgetItem()
        self.settings_formsListWidget.addItem(item)
        item = QtGui.QListWidgetItem()
        self.settings_formsListWidget.addItem(item)
        ...
        self.label_5 = QtGui.QLabel(self.formsandfieldsgridwidget)
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Times New Roman"))
        font.setPointSize(18)
        font.setBold(True)
        ...
        self.label_5.setStyleSheet(_fromUtf8("background-color:qlineargradient(spread:pad, x1:0, y1:0, x2:0.767, y2:0.773, stop:0 rgba(0, 203, 5, 252), stop:1 rgba(255, 77, 127, 150));"))
        ...
        self.settings_fieldsListwidget.setMaximumSize(QtCore.QSize(474, 16777215))
        self.settings_fieldsListwidget.setStyleSheet(_fromUtf8("background-color:rgb(229, 229, 229);"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.settings_fieldsknownRadioButton.setText(_translate("MainWindow", "From known fields", None))
        self.settings_fieldsunknownRadioButton.setText(_translate("MainWindow", "From Unknown fields", None))
        ...
        self.label_4.setText(_translate("MainWindow", "Forms", None))
        __sortingEnabled = self.settings_formsListWidget.isSortingEnabled()
        self.settings_formsListWidget.setSortingEnabled(False)
        item = self.settings_formsListWidget.item(0)
        item.setText(_translate("MainWindow", "Cadet details", None))
        item = self.settings_formsListWidget.item(1)
        item.setText(_translate("MainWindow", "Yoga Day", None))
        item = self.settings_formsListWidget.item(2)
        item.setText(_translate("MainWindow", "Enrolment Nominal roll", None))
        item = self.settings_formsListWidget.item(3)
        item.setText(_translate("MainWindow", "Camp Nominal roll", None))
        item = self.settings_formsListWidget.item(4)
        item.setText(_translate("MainWindow", "Scholarship NR", None))
        item = self.settings_formsListWidget.item(5)
        item.setText(_translate("MainWindow", "A certe NR for high school JDJW", None))
        item = self.settings_formsListWidget.item(6)
        item.setText(_translate("MainWindow", "B certe NR SDSW", None))
        item = self.settings_formsListWidget.item(7)
        item.setText(_translate("MainWindow", "C certe NR SDSW", None))
        item = self.settings_formsListWidget.item(8)
        item.setText(_translate("MainWindow", "C certe NR SDSW", None))
        item = self.settings_formsListWidget.item(9)
        item.setText(_translate("MainWindow", "Speciman signature of cadets", None))
        item = self.settings_formsListWidget.item(10)
        item.setText(_translate("MainWindow", "TADA to cadets camps", None))
        item = self.settings_formsListWidget.item(11)
        item.setText(_translate("MainWindow", "TADA to cadets for exam", None))
        self.settings_formsListWidget.setSortingEnabled(__sortingEnabled)
        self.settings_addformLineEdit.setPlaceholderText(_translate("MainWindow", "Enter New Form name", None))
        self.label_5.setText(_translate("MainWindow", "Fields", None))
        __sortingEnabled = self.settings_fieldsListwidget.isSortingEnabled()
        self.settings_fieldsListwidget.setSortingEnabled(False)
        item = self.settings_fieldsListwidget.item(0)
        item.setText(_translate("MainWindow", "Enrolment number", None))
        item = self.settings_fieldsListwidget.item(1)
        item.setText(_translate("MainWindow", "age", None))
        item = self.settings_fieldsListwidget.item(2)
        item.setText(_translate("MainWindow", "Gender", None))
        item = self.settings_fieldsListwidget.item(3)
        item.setText(_translate("MainWindow", "afads", None))
        item = self.settings_fieldsListwidget.item(4)
        item.setText(_translate("MainWindow", "dasfadsfadsf", None))
        item = self.settings_fieldsListwidget.item(5)
        item.setText(_translate("MainWindow", "adsfdas", None))
        item = self.settings_fieldsListwidget.item(6)
        item.setText(_translate("MainWindow", "dasfasdf", None))
        item = self.settings_fieldsListwidget.item(7)
        item.setText(_translate("MainWindow", "dasfsdafas", None))
        item = self.settings_fieldsListwidget.item(8)
        item.setText(_translate("MainWindow", "dasfghhgdaf", None))
        ...
        self.settings_fieldsComboBox.setItemText(0, _translate("MainWindow", "ds", None))
        self.settings_fieldsComboBox.setItemText(1, _translate("MainWindow", "f", None))
        self.settings_fieldsComboBox.setItemText(2, _translate("MainWindow", "ads", None))
        self.settings_fieldsComboBox.setItemText(3, _translate("MainWindow", "fds", None))
        self.settings_fieldsComboBox.setItemText(4, _translate("MainWindow", "f", None))
        self.settings_fieldsComboBox.setItemText(5, _translate("MainWindow", "dsf", None))
        self.settings_fieldsComboBox.setItemText(6, _translate("MainWindow", "sd", None))
        self.settings_fieldsComboBox.setItemText(7, _translate("MainWindow", "fds", None))
        self.settings_fieldsComboBox.setItemText(8, _translate("MainWindow", "f", None))
        self.settings_fieldsComboBox.setItemText(9, _translate("MainWindow", "dsf", None))
        self.settings_fieldsComboBox.setItemText(10, _translate("MainWindow", "ds", None))
        self.settings_fieldsComboBox.setItemText(11, _translate("MainWindow", "f", None))
        self.settings_fieldsComboBox.setItemText(12, _translate("MainWindow", "dsf", None))
        self.settings_fieldsComboBox.setItemText(13, _translate("MainWindow", "New Item", None))
