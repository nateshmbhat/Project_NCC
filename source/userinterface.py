...
"border-radius:5px;"))
        ...
        spacerItem22 = QtGui.QSpacerItem(0, 10, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
...
"}"))
        ...
        self.settingsscrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 1155, 2005))
