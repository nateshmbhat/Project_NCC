...
"text-shadow:0 1px 0 rgb(204,204,204) , 0 2px 0 rgb(201,201,201) , 0 3px 0 rgb(187,187,187) , 0 4px 0 rgb(185,185,185) , 0 5px 0 rgb(170,170,170) , 0 6px 1px rgba(0,0,0,0.0980392) , 0 0 5px rgba(0,0,0,0.0980392) , 0 1px 3px rgba(0,0,0,0.298039) , 0 3px 5px rgba(0,0,0,0.2) , 0 5px 10px rgba(0,0,0,0.247059) , 0 10px 10px rgba(0,0,0,0.2) , 0 20px 20px rgba(0,0,0,0.14902) ;"))
        ...
        self.searchFrame.setMinimumSize(QtCore.QSize(0, 50))
...
"}"))
        ...
        self.searchbyenLineEdit.setGeometry(QtCore.QRect(0, 0, 251, 26))
        font = QtGui.QFont()
        font.setPointSize(-1)
...
""))
        ...
        self.enrolmentnumRadioButton.setGeometry(QtCore.QRect(0, 30, 121, 17))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("georgia"))
        font.setBold(True)
        font.setWeight(75)
...
""))
        ...
        self.aadhaarnumRadioButton.setGeometry(QtCore.QRect(120, 30, 111, 17))
...
""))
        ...
        self.nameRadioButton = QtGui.QRadioButton(self.searchFrame)
        self.nameRadioButton.setGeometry(QtCore.QRect(230, 30, 71, 17))
        self.nameRadioButton.setStyleSheet(_fromUtf8("background-color:transparent;\n"
"color:white;\n"
"font-family:georgia;\n"
"font-weight:bold;\n"
""))
...
""))
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 1121, 1303))
...
""))
        ...
        self.gridLayout_3.addWidget(self.line_2, 13, 1, 1, 1, QtCore.Qt.AlignHCenter)
...
"margin-bottom:5px;"))
        ...
        self.gridLayout_3.addWidget(self.bankdetailsLabel, 7, 1, 1, 1, QtCore.Qt.AlignHCenter)
...
"}"))
        ...
        self.isfccodeLabel.setStyleSheet(_fromUtf8("background-color:transparent;"))
        ...
        self.gridLayout_3.addWidget(self.bankformFrame, 8, 1, 1, 1, QtCore.Qt.AlignHCenter)
...
"}"))
        ...
        self.gridLayout_3.addWidget(self.instFrame, 15, 1, 1, 1, QtCore.Qt.AlignHCenter)
...
""))
        ...
        self.enrollmentnumLabel = QtGui.QLabel(self.enrollformFrame)
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("georgia"))
        font.setPointSize(15)
        font.setBold(True)
        font.setWeight(75)
        self.enrollmentnumLabel.setFont(font)
        self.enrollmentnumLabel.setStyleSheet(_fromUtf8("background-color:transparent;"))
        self.enrollmentnumLabel.setObjectName(_fromUtf8("enrollmentnumLabel"))
        self.Enroll_form.setWidget(0, QtGui.QFormLayout.LabelRole, self.enrollmentnumLabel)
        self.enrollmentnumLineEdit = QtGui.QLineEdit(self.enrollformFrame)
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Georgia"))
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.enrollmentnumLineEdit.setFont(font)
        self.enrollmentnumLineEdit.setStyleSheet(_fromUtf8(""))
        self.enrollmentnumLineEdit.setInputMethodHints(QtCore.Qt.ImhDigitsOnly)
        self.enrollmentnumLineEdit.setText(_fromUtf8(""))
        self.enrollmentnumLineEdit.setObjectName(_fromUtf8("enrollmentnumLineEdit"))
        self.Enroll_form.setWidget(0, QtGui.QFormLayout.FieldRole, self.enrollmentnumLineEdit)
        self.rankLabel = QtGui.QLabel(self.enrollformFrame)
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Georgia"))
        font.setPointSize(15)
        font.setBold(True)
        ...
        self.Enroll_form.setWidget(2, QtGui.QFormLayout.LabelRole, self.rankLabel)
        self.rankLineEdit = QtGui.QLineEdit(self.enrollformFrame)
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Georgia"))
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.rankLineEdit.setFont(font)
        self.rankLineEdit.setObjectName(_fromUtf8("rankLineEdit"))
        self.Enroll_form.setWidget(2, QtGui.QFormLayout.FieldRole, self.rankLineEdit)
        ...
        self.Enroll_form.setWidget(3, QtGui.QFormLayout.LabelRole, self.aadhaarLabel)
        ...
        self.Enroll_form.setWidget(3, QtGui.QFormLayout.FieldRole, self.aadhaarLineEdit)
        ...
        self.Enroll_form.setWidget(5, QtGui.QFormLayout.LabelRole, self.fullnameLabel)
        ...
        self.Enroll_form.setWidget(5, QtGui.QFormLayout.FieldRole, self.fullnameLineEdit)
        ...
        self.Enroll_form.setWidget(6, QtGui.QFormLayout.LabelRole, self.fathernameLabel)
        ...
        self.Enroll_form.setWidget(6, QtGui.QFormLayout.FieldRole, self.fathernameLineEdit)
        ...
        self.Enroll_form.setWidget(7, QtGui.QFormLayout.LabelRole, self.mothernameLabel)
        ...
        self.Enroll_form.setWidget(7, QtGui.QFormLayout.FieldRole, self.mothernameLineEdit)
        ...
        self.Enroll_form.setWidget(8, QtGui.QFormLayout.LabelRole, self.sexLabel)
...
"align-content:center;"))
        ...
        self.sexComboBox.addItem(_fromUtf8(""))
        self.Enroll_form.setWidget(8, QtGui.QFormLayout.FieldRole, self.sexComboBox)
        ...
        self.Enroll_form.setWidget(12, QtGui.QFormLayout.LabelRole, self.dateofbirthLabel)
        ...
        self.Enroll_form.setWidget(12, QtGui.QFormLayout.FieldRole, self.dateofbirthDateEdit)
        ...
        self.Enroll_form.setWidget(13, QtGui.QFormLayout.LabelRole, self.addressLabel)
        self.addressTextEdit = QtGui.QTextEdit(self.enrollformFrame)
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Georgia"))
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.addressTextEdit.setStyleSheet(_fromUtf8(""))
        self.addressTextEdit.setObjectName(_fromUtf8("addressTextEdit"))
        self.Enroll_form.setWidget(13, QtGui.QFormLayout.FieldRole, self.addressTextEdit)
        ...
        self.Enroll_form.setWidget(14, QtGui.QFormLayout.LabelRole, self.emailLabel)
        ...
        self.Enroll_form.setWidget(14, QtGui.QFormLayout.FieldRole, self.emailLineEdit)
        ...
        self.Enroll_form.setWidget(15, QtGui.QFormLayout.LabelRole, self.mobileLabel)
        ...
        self.Enroll_form.setWidget(15, QtGui.QFormLayout.FieldRole, self.mobileLineEdit)
        ...
        self.Enroll_form.setWidget(16, QtGui.QFormLayout.LabelRole, self.bloodgroupLabel)
        ...
        self.Enroll_form.setWidget(16, QtGui.QFormLayout.FieldRole, self.bloodgroupLineEdit)
        self.gridLayout_3.addWidget(self.enrollformFrame, 2, 1, 1, 1, QtCore.Qt.AlignHCenter)
...
"font-size:50%;"))
        ...
        self.webView = QtWebKit.QWebView(self.Yoga)
        self.webView.setGeometry(QtCore.QRect(9, -1, 1111, 861))
        ...
        MainWindow.setTabOrder(self.searchPushButton, self.enrollmentnumLineEdit)
        MainWindow.setTabOrder(self.enrollmentnumLineEdit, self.aadhaarLineEdit)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.enrolltitleLabel.setText(_translate("MainWindow", "Enrollment Form", None))
        self.searchbyenLineEdit.setPlaceholderText(_translate("MainWindow", "Search by", None))
        ...
        self.nameRadioButton.setText(_translate("MainWindow", "Name", None))
        ...
        self.enrollmentnumLabel.setText(_translate("MainWindow", "Enrolment No.", None))
        ...
        self.mytab.setTabText(self.mytab.indexOf(self.Enroll), _translate("MainWindow", "Enrollment form", None))
        self.mytab.setTabToolTip(self.mytab.indexOf(self.Enroll), _translate("MainWindow", "Enrollment form for NCC", None))
