...
"}"))
        ...
        self.settingsscrollAreaWidgetContents.setGeometry(QtCore.QRect(0, -141, 1066, 1018))
...
"color:white;"))
        ...
        self.formsandfieldsgridwidget.setMinimumSize(QtCore.QSize(0, 550))
...
"text-align:center;"))
        ...
        self.settings_formslist = QtGui.QListWidget(self.formsandfieldsgridwidget)
        self.settings_formslist.setMinimumSize(QtCore.QSize(400, 300))
        self.settings_formslist.setMaximumSize(QtCore.QSize(475, 16777215))
        self.settings_formslist.setObjectName(_fromUtf8("settings_formslist"))
        ...
        self.settings_formslist.addItem(item)
        item = QtGui.QListWidgetItem()
        self.settings_formslist.addItem(item)
        item = QtGui.QListWidgetItem()
        self.settings_formslist.addItem(item)
        ...
        item = QtGui.QListWidgetItem()
        self.settings_formslist.addItem(item)
        self.verticalLayout_6.addWidget(self.settings_formslist)
        ...
        self.settings_fieldslist = QtGui.QListWidget(self.formsandfieldsgridwidget)
        self.settings_fieldslist.setMinimumSize(QtCore.QSize(400, 0))
        self.settings_fieldslist.setMaximumSize(QtCore.QSize(474, 16777215))
        self.settings_fieldslist.setObjectName(_fromUtf8("settings_fieldslist"))
        item = QtGui.QListWidgetItem()
        ...
        item.setBackground(brush)
        self.settings_fieldslist.addItem(item)
        item = QtGui.QListWidgetItem()
        self.settings_fieldslist.addItem(item)
        item = QtGui.QListWidgetItem()
        self.settings_fieldslist.addItem(item)
        ...
        item = QtGui.QListWidgetItem()
        self.settings_fieldslist.addItem(item)
        self.verticalLayout_7.addWidget(self.settings_fieldslist)
        ...
        self.horizontalLayout_16.addWidget(self.settings_addfieldLineEdit)
        ...
        self.gridLayout_12.addWidget(self.settings_addfieldPushButton, 3, 2, 1, 1)
        ...
        self.gridLayout_12.addWidget(self.settings_addformPushButton, 3, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        __sortingEnabled = self.settings_formslist.isSortingEnabled()
        self.settings_formslist.setSortingEnabled(False)
        item = self.settings_formslist.item(0)
        item.setText(_translate("MainWindow", "Cadet details", None))
        item = self.settings_formslist.item(1)
        item.setText(_translate("MainWindow", "Yoga Day", None))
        item = self.settings_formslist.item(2)
        item.setText(_translate("MainWindow", "Enrolment Nominal roll", None))
        item = self.settings_formslist.item(3)
        item.setText(_translate("MainWindow", "Camp Nominal roll", None))
        item = self.settings_formslist.item(4)
        item.setText(_translate("MainWindow", "Scholarship NR", None))
        item = self.settings_formslist.item(5)
        item.setText(_translate("MainWindow", "A certe NR for high school JDJW", None))
        item = self.settings_formslist.item(6)
        item.setText(_translate("MainWindow", "B certe NR SDSW", None))
        item = self.settings_formslist.item(7)
        item.setText(_translate("MainWindow", "C certe NR SDSW", None))
        item = self.settings_formslist.item(8)
        item.setText(_translate("MainWindow", "C certe NR SDSW", None))
        item = self.settings_formslist.item(9)
        item.setText(_translate("MainWindow", "Speciman signature of cadets", None))
        item = self.settings_formslist.item(10)
        item.setText(_translate("MainWindow", "TADA to cadets camps", None))
        item = self.settings_formslist.item(11)
        item.setText(_translate("MainWindow", "TADA to cadets for exam", None))
        item = self.settings_formslist.item(12)
        item.setText(_translate("MainWindow", "Marks (A)", None))
        item = self.settings_formslist.item(13)
        item.setText(_translate("MainWindow", "Marks (B)", None))
        item = self.settings_formslist.item(14)
        item.setText(_translate("MainWindow", "Marks (C)", None))
        self.settings_formslist.setSortingEnabled(__sortingEnabled)
        ...
        __sortingEnabled = self.settings_fieldslist.isSortingEnabled()
        self.settings_fieldslist.setSortingEnabled(False)
        item = self.settings_fieldslist.item(0)
        item.setText(_translate("MainWindow", "Enrolment number", None))
        item = self.settings_fieldslist.item(1)
        item.setText(_translate("MainWindow", "age", None))
        item = self.settings_fieldslist.item(2)
        item.setText(_translate("MainWindow", "Gender", None))
        item = self.settings_fieldslist.item(3)
        item.setText(_translate("MainWindow", "afads", None))
        item = self.settings_fieldslist.item(4)
        item.setText(_translate("MainWindow", "dasfadsfadsf", None))
        item = self.settings_fieldslist.item(5)
        item.setText(_translate("MainWindow", "adsfdas", None))
        item = self.settings_fieldslist.item(6)
        item.setText(_translate("MainWindow", "dasfasdf", None))
        item = self.settings_fieldslist.item(7)
        item.setText(_translate("MainWindow", "dasfsdafas", None))
        item = self.settings_fieldslist.item(8)
        item.setText(_translate("MainWindow", "dasfghhgdaf", None))
        self.settings_fieldslist.setSortingEnabled(__sortingEnabled)
