...
"color:white;"))
        ...
        self.aadhaarLineEdit.setMaxLength(14)
...
"}"))
        ...
        self.institutioncomboBox = QtGui.QComboBox(self.uploaddatainstiframe)
        font = QtGui.QFont()
        font.setPointSize(-1)
        self.institutioncomboBox.setFont(font)
...
"}"))
        ...
        self.webView_3 = QtWebKit.QWebView(self.uploaddatamainframe)
...
"}"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.aadhaarLineEdit.setInputMask(_translate("MainWindow", "0000 0000 0000; ", None))
        self.aadhaarLineEdit.setText(_translate("MainWindow", "  ", None))
