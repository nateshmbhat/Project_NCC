...
""))
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 966, 2245))
...
"}"))
        ...
        MainWindow.setTabOrder(self.aadhaarLineEdit, self.sexComboBox)
        ...
        MainWindow.setTabOrder(self.CcertRadioButton, self.extraactivitiesTextEdit)
        ...
        MainWindow.setTabOrder(self.enrolPushButton, self.mytab)
